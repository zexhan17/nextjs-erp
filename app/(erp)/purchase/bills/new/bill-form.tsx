...
import { createVendorBillAction } from "../../actions";
...
export function BillForm({ vendors }: { vendors: Vendor[] }) {
    ...
    async function handleAction(_prev: unknown, formData: FormData) {
        ...
        const result = await createVendorBillAction(formData);
        if (result?.success && "billId" in result) {
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="reference" name="reference" placeholder="Vendor invoice #" />
                                </div>
                            </CardContent>
                        </Card>
